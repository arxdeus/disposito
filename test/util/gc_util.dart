// Originally created by Henri Chen<chenhenri@gmail.com>
// https://github.com/henrichen
...
class Log {
  static void d(String name, String message) => Logger(name).info(message);
  static void w(String name, String message) => Logger(name).warning(message);
  static void e(String name, String message) => Logger(name).severe(message);
  static void printOn(String name) {
  ...
  static void printOff(String name) => Logger(name).clearListeners();
}
