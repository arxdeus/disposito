...
abstract final class DisposeTracker {
  ...
  static final disposeHolders =
      UnmodifiableMapView(DisposeRegistry.registeredHolders);
  ...
  @visibleForTesting
  static bool get hasUndisposedHolders =>
      DisposeRegistry.registeredHolders.isNotEmpty;
