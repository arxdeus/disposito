...
extension DisposableExtension<D extends Disposable> on D {
  D bindDisposeTo(CustomDisposableCallHost disposeHolder) =>
      disposeHolder.bindDisposable(this, dispose: dispose);
}
